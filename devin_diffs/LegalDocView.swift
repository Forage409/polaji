    ...
    var sections: [(String, String)] {
        ...
        case .privacy:
            return [
                ...
                """),
                ("六、联系我们", """
                如对隐私政策有任何疑问，可通过"意见反馈"功能联系开发者邮箱。
                """)
            ]
        case .terms:
            return [
                ("一、服务说明", """
                整活局是一款由开发者独立开发的中文整活卡片生成工具。所有模板、文案库均为虚构创作，内容仅供朋友间娱乐使用，请勿当真。
                """),
                ("二、用户行为规范", """
                你不得使用本 App 生成的内容进行：
                • 人身攻击、辱骂或网络暴力
                ...
                """),
                ("四、知识产权", """
                整活局 App 的图标、UI、模板文案、卡片样式版权均归开发者所有。生成的卡片仅供个人非商业用途使用，未经授权不得用于商业宣传。
                """),
                ("五、付费与会员", """
