    ...
    var sections: [(String, String)] {
        ...
        case .privacy:
            return [
                ...
                """),
                ("五、AI 优化服务", """
                当你主动点击 AI 优化或 AI 帮写玩法时，App 会将本次必要的玩法标题、结果文案和填写内容通过整活局 Cloudflare Worker 转发至 Cloudflare Workers AI，用于即时生成优化文案。整活局不会持久化保存这些输入内容或 AI 输出文案，仅保存匿名设备标识、功能类型、调用状态和调用时间，用于限制试用次数、防止滥用和排查服务异常。
                """),
                ("六、联系我们", """
